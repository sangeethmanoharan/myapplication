...
class SmbComRename extends ServerMessageBlock {
    ...
    public String toString() {
        return new String(new StringBuffer().append("SmbComRename[").append(super.toString()).append(",searchAttributes=0x").append(Hexdump.toHexString(this.searchAttributes, 4)).append(",oldFileName=").append(this.oldFileName).append(",newFileName=").append(this.newFileName).append("]").toString());
    }
}
