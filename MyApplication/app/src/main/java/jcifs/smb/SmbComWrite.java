...
class SmbComWrite extends ServerMessageBlock {
    ...
    public String toString() {
        return new String(new StringBuffer().append("SmbComWrite[").append(super.toString()).append(",fid=").append(this.fid).append(",count=").append(this.count).append(",offset=").append(this.offset).append(",remaining=").append(this.remaining).append("]").toString());
    }
}
