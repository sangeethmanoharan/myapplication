...
class Trans2QueryFSInformation extends SmbComTransaction {
    ...
    public String toString() {
        return new String(new StringBuffer().append("Trans2QueryFSInformation[").append(super.toString()).append(",informationLevel=0x").append(Hexdump.toHexString(this.informationLevel, 3)).append("]").toString());
    }
}
