    ...
    String rrToString() {
        ...
        if (this.other == null) {
            ...
            if (this.error != 18) {
                ...
                long time = (((((((long) (this.other[0] & Type.ANY)) << 40) + (((long) (this.other[1] & Type.ANY)) << 32)) + ((long) ((this.other[2] & Type.ANY) << 24))) + ((long) ((this.other[3] & Type.ANY) << 16))) + ((long) ((this.other[4] & Type.ANY) << 8))) + ((long) (this.other[5] & Type.ANY));
