...
class SmbComNegotiate extends ServerMessageBlock {
    ...
    public String toString() {
        return new String(new StringBuffer().append("SmbComNegotiate[").append(super.toString()).append(",wordCount=").append(this.wordCount).append(",dialects=NT LM 0.12]").toString());
    }
}
