...
class TransTransactNamedPipe extends SmbComTransaction {
    ...
    TransTransactNamedPipe(int fid, byte[] data, int off, int len) {
        ...
        this.maxDataCount = Message.MAXLENGTH;
    ...
    public String toString() {
        return new String(new StringBuffer().append("TransTransactNamedPipe[").append(super.toString()).append(",pipeFid=").append(this.pipeFid).append("]").toString());
    }
}
