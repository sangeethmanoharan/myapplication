...
public class DNSOutput {
    ...
    public void writeU16At(int val, int where) {
        ...
        int i = where + 1;
        this.array[where] = (byte) ((val >>> 8) & Type.ANY);
        where = i + 1;
        this.array[i] = (byte) (val & Type.ANY);
    }
