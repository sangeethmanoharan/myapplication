...
class Trans2SetFileInformation extends SmbComTransaction {
    ...
    int writeDataWireFormat(byte[] dst, int dstIndex) {
        ...
        ServerMessageBlock.writeInt8(0, dst, dstIndex);
        dstIndex += 8;
        ServerMessageBlock.writeInt2((long) (this.attributes | Flags.FLAG8), dst, dstIndex);
        dstIndex += 2;
        ServerMessageBlock.writeInt8(0, dst, dstIndex);
    ...
    public String toString() {
        return new String(new StringBuffer().append("Trans2SetFileInformation[").append(super.toString()).append(",fid=").append(this.fid).append("]").toString());
    }
}
