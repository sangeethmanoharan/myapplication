...
class SmbComNTCreateAndX extends AndXServerMessageBlock {
    ...
    SmbComNTCreateAndX(String name, int flags, int access, int shareAccess, int extFileAttributes, int createOptions, ServerMessageBlock andx) {
        ...
        this.desiredAccess |= Service.NETBIOS_NS;
    ...
    public String toString() {
        return new String(new StringBuffer().append("SmbComNTCreateAndX[").append(super.toString()).append(",flags=0x").append(Hexdump.toHexString(this.flags0, (int) SECURITY_EFFECTIVE_ONLY)).append(",rootDirectoryFid=").append(this.rootDirectoryFid).append(",desiredAccess=0x").append(Hexdump.toHexString(this.desiredAccess, (int) FILE_SEQUENTIAL_ONLY)).append(",allocationSize=").append(this.allocationSize).append(",extFileAttributes=0x").append(Hexdump.toHexString(this.extFileAttributes, (int) FILE_SEQUENTIAL_ONLY)).append(",shareAccess=0x").append(Hexdump.toHexString(this.shareAccess, (int) FILE_SEQUENTIAL_ONLY)).append(",createDisposition=0x").append(Hexdump.toHexString(this.createDisposition, (int) FILE_SEQUENTIAL_ONLY)).append(",createOptions=0x").append(Hexdump.toHexString(this.createOptions, 8)).append(",impersonationLevel=0x").append(Hexdump.toHexString(this.impersonationLevel, (int) FILE_SEQUENTIAL_ONLY)).append(",securityFlags=0x").append(Hexdump.toHexString(this.securityFlags, (int) SECURITY_EFFECTIVE_ONLY)).append(",name=").append(this.path).append("]").toString());
    }
}
