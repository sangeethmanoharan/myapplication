...
class SmbComDelete extends ServerMessageBlock {
    ...
    public String toString() {
        return new String(new StringBuffer().append("SmbComDelete[").append(super.toString()).append(",searchAttributes=0x").append(Hexdump.toHexString(this.searchAttributes, 4)).append(",fileName=").append(this.path).append("]").toString());
    }
}
