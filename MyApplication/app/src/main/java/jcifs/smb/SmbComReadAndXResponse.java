...
class SmbComReadAndXResponse extends AndXServerMessageBlock {
    ...
    public String toString() {
        return new String(new StringBuffer().append("SmbComReadAndXResponse[").append(super.toString()).append(",dataCompactionMode=").append(this.dataCompactionMode).append(",dataLength=").append(this.dataLength).append(",dataOffset=").append(this.dataOffset).append("]").toString());
    }
}
