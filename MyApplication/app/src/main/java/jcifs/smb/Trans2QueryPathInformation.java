...
class Trans2QueryPathInformation extends SmbComTransaction {
    ...
    public String toString() {
        return new String(new StringBuffer().append("Trans2QueryPathInformation[").append(super.toString()).append(",informationLevel=0x").append(Hexdump.toHexString(this.informationLevel, 3)).append(",filename=").append(this.path).append("]").toString());
    }
}
