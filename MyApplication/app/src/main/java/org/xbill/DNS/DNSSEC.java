...
public class DNSSEC {
    ...
    private static final ECKeyInfo ECDSA_P384 = new ECKeyInfo(ASN1_SEQ, "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFF0000000000000000FFFFFFFF", "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFF0000000000000000FFFFFFFC", "B3312FA7E23EE7E4988E056BE3F82D19181D9C6EFE8141120314088F5013875AC656398D8A2ED19D2A85C8EDD3EC2AEF", "AA87CA22BE8B05378EB1C71EF320AD746E1D3B628BA79B9859F741E082542A385502F25DBF55296C3A545E3872760AB7", "3617DE4A96262C6F5D9E98BF9292DC29F8F41DBD289A147CE9DA3113B5F0B8C00A60B1CE1D7E819D7A431D7C90EA0E5F", "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFC7634D81F4372DDF581A0DB248B0A77AECEC196ACCC52973");
    ...
    public static class Algorithm {
        ...
        private static Mnemonic algs = new Mnemonic("DNSSEC algorithm", DH);
    ...
    private static class ECKeyInfo {
        public BigInteger a;
        public BigInteger b;
        EllipticCurve curve = new EllipticCurve(new ECFieldFp(this.p), this.a, this.b);
        public BigInteger gx;
        public BigInteger gy;
        int length;
        public BigInteger n;
        public BigInteger p;
        ECParameterSpec spec = new ECParameterSpec(this.curve, new ECPoint(this.gx, this.gy), this.n, 1);
