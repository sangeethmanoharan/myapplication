...
class SmbComReadAndX extends AndXServerMessageBlock {
    ...
    public String toString() {
        return new String(new StringBuffer().append("SmbComReadAndX[").append(super.toString()).append(",fid=").append(this.fid).append(",offset=").append(this.offset).append(",maxCount=").append(this.maxCount).append(",minCount=").append(this.minCount).append(",openTimeout=").append(this.openTimeout).append(",remaining=").append(this.remaining).append(",offset=").append(this.offset).append("]").toString());
    }
}
