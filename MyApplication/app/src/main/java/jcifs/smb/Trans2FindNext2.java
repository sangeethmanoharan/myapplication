...
class Trans2FindNext2 extends SmbComTransaction {
    ...
    public String toString() {
        return new String(new StringBuffer().append("Trans2FindNext2[").append(super.toString()).append(",sid=").append(this.sid).append(",searchCount=").append(Trans2FindFirst2.LIST_SIZE).append(",informationLevel=0x").append(Hexdump.toHexString(this.informationLevel, 3)).append(",resumeKey=0x").append(Hexdump.toHexString(this.resumeKey, 4)).append(",flags=0x").append(Hexdump.toHexString(this.flags, 2)).append(",filename=").append(this.filename).append("]").toString());
    }
}
