...
public final class Lookup {
    ...
    private static final Name[] noAliases = new Name[SUCCESSFUL];
    ...
    public static synchronized void setDefaultSearchPath(String[] domains) throws TextParseException {
        synchronized (Lookup.class) {
            if (domains == null) {
                ...
                for (int i = SUCCESSFUL; i < domains.length; i += UNRECOVERABLE) {
    ...
    public Lookup(Name name, int type) {
        this(name, type, (int) UNRECOVERABLE);
    }
    ...
    public Lookup(String name, int type) throws TextParseException {
        this(Name.fromString(name), type, (int) UNRECOVERABLE);
    }

    public Lookup(String name) throws TextParseException {
        this(Name.fromString(name), (int) UNRECOVERABLE, (int) UNRECOVERABLE);
    }
    ...
    private void processResponse(Name name, SetResponse response) {
        if (response.isSuccessful()) {
            ...
            for (int i = SUCCESSFUL; i < rrsets.length; i += UNRECOVERABLE) {
